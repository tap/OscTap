/*
    ...
    so existing <oscpack/ip/AbstractUdpSocket.h> consumers keep compiling unchanged.

    Deprecated: prefer <osctap/ip/AbstractUdpSocket.h>. See ROADMAP.md / docs/STATUS.md.
*/
