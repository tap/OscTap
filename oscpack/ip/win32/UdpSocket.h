/*
    ...
    so existing <oscpack/ip/win32/UdpSocket.h> consumers keep compiling unchanged.

    Deprecated: prefer <osctap/ip/win32/UdpSocket.h>. See ROADMAP.md / docs/STATUS.md.
*/
