/*
    ...
    so existing <oscpack/ip/NetworkingUtils.h> consumers keep compiling unchanged.

    Deprecated: prefer <osctap/ip/NetworkingUtils.h>. See ROADMAP.md / docs/STATUS.md.
*/
