/*
    ...
    so existing <oscpack/osc/SmallString.h> consumers keep compiling unchanged.

    Deprecated: prefer <osctap/osc/SmallString.h>. See ROADMAP.md / docs/STATUS.md.
*/
#include <osctap/osc/SmallString.h>
