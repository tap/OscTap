/*
    ...
    so existing <oscpack/osc/OscPacketListener.h> consumers keep compiling unchanged.

    Deprecated: prefer <osctap/osc/OscPacketListener.h>. See ROADMAP.md / docs/STATUS.md.
*/
