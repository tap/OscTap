/*
    ...
    so existing <oscpack/osc/OscTypesTraits.h> consumers keep compiling unchanged.

    Deprecated: prefer <osctap/osc/OscTypesTraits.h>. See ROADMAP.md / docs/STATUS.md.
*/
#include <osctap/osc/OscTypesTraits.h>
