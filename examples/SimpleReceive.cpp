...
protected:
    void ProcessMessage( const ReceivedMessage& m,
                         const IpEndpointName& remoteEndpoint ) override
    {
        ...
        try{
            ...
            if( std::strcmp( m.AddressPattern(), "/test1" ) == 0 ){
                ...
                bool a1; int32_t a2; float a3; const char *a4;
...
namespace { UdpListeningReceiveSocket* gSocket = nullptr;
...
int main(int argc, char* argv[])
{
    ...
    UdpListeningReceiveSocket s(
            IpEndpointName( IpEndpointName::ANY_ADDRESS, PORT ), &listener );
